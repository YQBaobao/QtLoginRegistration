...
class UiLoginRegisterQDialog(QDialog, Ui_LoginRegister):
    ...
    def init_ui(self):
        ...
        # 注册页需要绑定的信号
        self.lineEdit_3.textEdited.connect(lambda: self.check_password(self.lineEdit_3, self.lineEdit_4, self.label_9))
    ...
    def check_password(self, password_line_edit, old_password_line_edit, label):
        """重复密码的验证"""
